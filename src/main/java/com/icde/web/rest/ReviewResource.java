...
/**
 * REST controller for managing {@link com.icde.domain.Review}.
 */
@RestController
@RequestMapping("/api")
public class ReviewResource {
    ...
    public ResponseEntity<Review> partialUpdateReview(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, review.getId()));
    }
